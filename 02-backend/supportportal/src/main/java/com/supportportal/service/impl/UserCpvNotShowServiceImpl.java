...
public class UserCpvNotShowServiceImpl implements UserCpvNotShowService {
    ...
    @Override
    public List<UserCpvNotShowDb> findAllByUsernameOrderByCpvDbIdAsc(String username) {
        return userCpvNotShowRepository.findAllByUsernameOrderByCpvDbIdAsc(username);
    }
    ...
    public UserCpvNotShowDb save(UserCpvNotShowDb cpvNotShow, String lang) throws CpvAlreadyAddedException, MoreGenericNotShowCpvAddedException {
        List<UserCpvNotShowDb> list = userCpvNotShowRepository.findAllByUsernameOrderByCpvDbIdAsc(cpvNotShow.getUsername());
