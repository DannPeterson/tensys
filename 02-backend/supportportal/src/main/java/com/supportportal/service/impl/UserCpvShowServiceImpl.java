...
public class UserCpvShowServiceImpl implements UserCpvShowService {
    ...
    @Override
    public List<UserCpvShowDb> findAllByUsernameOrderByCpvDbIdAsc(String username) {
        return userCpvShowRepository.findAllByUsernameOrderByCpvDbIdAsc(username);
    }
    ...
    public UserCpvShowDb save(UserCpvShowDb cpvShow, String lang) throws CpvAlreadyAddedException, MoreGenericShowCpvAddedException {
        List<UserCpvShowDb> list = userCpvShowRepository.findAllByUsernameOrderByCpvDbIdAsc(cpvShow.getUsername());
